...
def predict_sentiments(headlines: list, model, transformer) -> list:
    """
    ...
    Inputs:
        ...
        transformer: SentenceTransformer for encoding headlines
 
    Returns:
        list: List of predictions (sentiments)
    """
    try:
        # Encode headlines and make predictions
...
def save_file(results, source):
    ...
    # Now let's read the file back and print it line by line
    try:
...
def main():
    ...
    results = predict_sentiments(headlines, sentiment_classifier, transformer_model)
